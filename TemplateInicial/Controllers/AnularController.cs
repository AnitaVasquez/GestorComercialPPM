...
{
    [Autenticado]
    public class AnularController : BaseAppController
    {
        // GET: Prefactura
        ...
        {
            ViewBag.NombreListado = Etiquetas.TituloGridNotaCreditoAnularFactura; 
            ...
            //Búsqueda
            var listado = PrefacturasSAFIEntity.ListadoFacturasAprobadas();
        ...
        {
            ViewBag.TituloModal = "Solicitar Nota de Crédito";
            SolicitudesDeNotaDeCredito notaCredito = new SolicitudesDeNotaDeCredito();
            notaCredito.id_facturacion_safi = id;
            notaCredito.prefacturar = true;
            return PartialView(notaCredito);
        }

        public ActionResult ReversarConsolidacion(SolicitudesDeNotaDeCredito notaCredito)
        {
            bool ajax = false;
            ...
            //    }
            //    else
                   return Json(new { Resultado = new RespuestaTransaccion { Estado = false, Respuesta = "" } }, JsonRequestBehavior.AllowGet);
            //}
        }
