...
namespace GestionPPM.Entidades.Modelo
{
    ...
    public partial class ClientesInfo
    {
        ...
        public Nullable<int> CodigoCatalogoPotencialCrecimiento { get; set; }
        public string CategorizacionCliente { get; set; }
        public Nullable<int> CodigoCatalogoCategorizacionCliente { get; set; }
    }
}
