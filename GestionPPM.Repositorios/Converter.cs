...
namespace OfficeToPDF
{
    ...
    public class Converter
    {
        ...
        public static DocumentFileTypes FileStreamDocumentType(Stream stream)
        {
        ...
        public static DocumentFileTypes FileStreamDocumentType(Stream stream, ref byte[] compObjHeader)
        {
        ...
        public static bool IsCDFReadOnlyEnforced(string filename)
        {
        ...
        public static bool IsOpenXMLReadOnlyEnforced(string filename)
        {
